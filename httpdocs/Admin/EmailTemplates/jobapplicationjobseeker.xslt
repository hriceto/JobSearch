...
>
    ...
    <xsl:template match="/">
        Dear <xsl:value-of select="$FirstName"/>&#160;<xsl:value-of select="$LastName"/>,
        <br /><br />
        Your job application for the job posting titled "<xsl:value-of select="root/JobPost/Title"/>" was submitted successfully.
        <br /><br />
        Thank you for using our site and best of luck in your job search!
        <br /><br />
        Sincerely,
        <br /><br />
